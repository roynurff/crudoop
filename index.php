...
<html lang="en">
  ...
  <body>
    <div class="container">
    <div class="mt-3">
    <h1 class="text-center">CRUD OOP</h1>
    <h2 class="text-center">Kelompok 1</h2>
    </div>

<!-- CARD -->
            <div class="card mt-3">
        <div class="card-header bg-secondary text-white text-center">
            Data Mahasiswa Universitas Negeri Surabaya
            <i class="fa-solid fa-icons"></i>
        </div>
        <div class="card-body bg-light">
<!-- Button trigger modal -->
<button type="button" class="btn btn-warning text-white mb-4" name="btambah"data-bs-toggle="modal" data-bs-target="#staticBackdrop1">
...
<div class="input-group mb-3">
  <input type="text" name="tcari" class="form-control" placeholder="Cari apa sih ... ">
...
<tr>
    ...
    <th><?= $data['prodi'] ?></th>
    <th>
        <a href="#" class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#staticBackdrop2<?= $no ?>">
        <i class="fa-regular fa-solid fa-pen"></i></a>
        <a href="#" class="btn btn-danger"  data-bs-toggle="modal" data-bs-target="#staticBackdrop3<?= $no ?>">
        <i class="fa-solid fa-trash"></i></a>
    </th>
</tr>

<!-- Awal Modal Ubah -->
<div class="modal fade" id="staticBackdrop2<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" 
  ...
  <div class="mb-3">
    ...
    <select class="form-select" name="tprodi">
      ...
      <button type="submit" class="btn btn-primary text-white" name="bubah">
...
<!-- Awal Modal Hapus -->
<div class="modal fade" id="staticBackdrop3<?= $no ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" 
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
  ...
  <span class="text-danger"><?= $data['nim'] ?> - <?= $data['nama'] ?></span>
      ...
      <div class="modal-footer">
      <button type="submit" class="btn btn-danger text-white" name="bhapus">
...
<div class="modal fade" id="staticBackdrop1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" 
  ...
  <div class="mb-3">
    ...
    <select class="form-select" name="tprodi">
      ...
      <div class="modal-footer">
      <button type="submit" class="btn btn-warning text-white" name="bsimpan">
      <i class="fa-solid fa-plus"></i>
      </button>
        <button type="button" class="btn btn-dark" data-bs-dismiss="modal">
        <i class="fa-brands fa-x-twitter"></i>
...
<!-- END CARD -->
    ...
    <script src="https://kit.fontawesome.com/f77f9f6f3f.js" crossorigin="anonymous"></script>
